<template>
  <div>
    <br>
    <h2 class="red darken-4 mb-2 text-xs-center white--text">Formulaire de candidature</h2>
    <br>
    <br>
    <br>
    ...
    <v-card color="grey lighten-4" flat>
     <v-card-text>
       <v-subheader>Quel est le marché cible de votre produit? Quels en seraient les utilisateurs finaux?</v-subheader>
       <v-container fluid>
         <v-layout row>
           <v-flex xs12>
             <v-text-field
    ...
    <div class="red darken-4 white--text">
      ...
      <!-- <v-card color="grey lighten-4" flat>
      <v-card-text>
        <v-subheader>Donnez un autre exemple de quelque chose que vous avez fait, créé ou auquel vous avez contribué qui montre votre capacité managériale. </v-subheader>
        <v-container fluid>
          <v-layout row>
            <v-flex xs12>
              <v-text-field
      ...
      <v-card color="grey lighten-4" flat>
      <v-card-text>
       <v-subheader>Optionnel: Donnez un autre exemple de quelque chose que vous avez fait, créé ou auquel vous avez contribué qui montre votre capacité managériale. </v-subheader>
       <v-container fluid>
         <v-layout row>
           <v-flex xs12>
             <v-text-field
       ...
       <v-card color="grey lighten-4" flat>
        <v-card-text>
          <v-subheader>Quel(s) rôle(s) pensez-vous prendre dans votre startup? Quelles sont les compétences techniques ou business qui feraient de vous le candidat idéal pour le(s) rôle(s)? </v-subheader>
          <v-container fluid>
            <v-layout row>
              <v-flex xs12>
                <v-text-field
      ...
      <v-card color="grey lighten-4" flat>
       <v-card-text>
         <v-subheader>Quel est l’expertise professionnelle que vous pourriez apporter à votre projet ou à Demain? </v-subheader>
         <v-container fluid>
           <v-layout row>
             <v-flex xs12>
               <v-text-field
      ...
      <!-- <v-card color="grey lighten-4" flat>
       <v-card-text>
         <v-subheader>Décrivez votre acte de persuasion le plus impressionnant et quel en a été le résultat. </v-subheader>
         <v-container fluid>
           <v-layout row>
             <v-flex xs12>
               <v-text-field
      ...
      <br>
      <div class="red darken-4 white--text">
    <h4>Votre position actuelle au sein du groupe Prisma Media</h4>
    </div>
    <br>
    <br>
    <v-container fluid>
   ...
   <v-card color="grey lighten-4" flat>
    <v-card-text>
      <v-subheader>Depuis combien de temps travaillez-vous chez Prisma Media? Quelle(s) position(s) avez-vous occupée(s)?</v-subheader>
      <v-container fluid>
        <v-layout row>
          <v-flex xs12>
            <v-text-field
   ...
   <v-layout row wrap>
     <v-flex xs12 md6>
       <v-subheader>De quel type est votre contrat de travail?</v-subheader>
       <v-card flat>
         <v-card-text>
           <v-radio-group v-model="ex8" :mandatory="false">
